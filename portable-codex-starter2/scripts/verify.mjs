...
const fullTarget = mkdtempSync(join(tmpdir(), "portable-codex-starter2-full-"));
const coreTarget = mkdtempSync(join(tmpdir(), "portable-codex-starter2-core-"));
const codexSkillsTarget = mkdtempSync(join(tmpdir(), "portable-codex-starter2-codex-skills-"));
const bothSkillsTarget = mkdtempSync(join(tmpdir(), "portable-codex-starter2-both-skills-"));
