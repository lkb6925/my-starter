...
3. If output contains `[SKIP] test (package.json script not found)`, stop immediately. You must set up a test runner (Vitest/Jest), add a `test` script, and create at least one sanity test before continuing.
