...
- Use structural search tools to find structural performance anti-patterns.
- Use available diagnostics tools to check for type issues that affect performance.
</tools>
