...
7) Use available diagnostics tools and structural search tools to supplement manual review.
</explore>
...
- Use available diagnostics tools to check for type errors.
- Use structural search tools to find structural anti-patterns (e.g., functions > 50 lines, deeply nested conditionals).
